...
router.get('/get-water-level', async (req, res) => {
    try {
...
router.get('/waterlevels-month', async (req, res) => {
    try {
...
router.get('/waterlevels-last-24-hours', async (req, res) => {
  try {
...
router.post('/add-water-level', async (req, res) => {
  try {
